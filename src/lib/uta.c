 ...
 */
uta_rc uta_get_version(const uta_context_v1_t * uta_context, uta_version_t * version)
{
    ...
    (void)sscanf(VERSION, "%u.%u.%u", &(version->major), &(version->minor), &(version->patch));
 ...
 */
size_t uta_len_key_max(void) { return 32; }
